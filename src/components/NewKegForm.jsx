...
const NewKegForm = (props) => {
    ...
    let _dateTimeTapped = null;
    const handleSubmission = (event) => {
        event.preventDefault();
        props.onKegCreation({name: _name.value, type:_type.value, brewer: _brewer, _description: _description.value, dateTapped: _dateTimeTapped.value, id: v4() });
        _name = '';
        _description = '';
        _type = '';
        _dateTapped = '';
    ...
    return (
        <div>
            <form onSubmit={handleSubmission}>
                ...
                <input type='date' id='date' placeholder='date' ref={(input) => {_dateTimeTapped=input;}}/>
            </form>
        </div>
